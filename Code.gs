  ...
  try {
    ...
    if (logSheet.getLastRow() === 0) {
      logSheet.appendRow([
        ...
        'Super Clear Tabs','Pool Acid','Alum Powder','Shock (500g)',
    ...
    logSheet.appendRow([
      ...
      data.chem6, data.chem7, data.chem8, data.chem9,
    ...
    var chemList = [
      ...
      data.chem9  !== '—' ? 'Shock (500g) x' + data.chem9 : ''
